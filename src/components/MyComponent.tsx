"use client";
import { AnimatePresence, animate, motion, stagger, useAnimate, usePresence , AnimationPlaybackControls } from "framer-motion";
...
const MyComponent = ({ children, childrenKey }: any) => {
  ...
  useEffect(() => {
     if (isPresent) {
       ...
       const controls =  animate([
          ["#boxs",{ opacity: [0, 1], x: ["-100%", "0%"], borderTopRightRadius: ["150px", "0px"], borderBottomRightRadius:["150px", "0px"], },{ duration: 2 } ],
          [".wwww", {  x: [0, 100], backgroundColor: "#b26464",  }, { duration: 4, delay: stagger(1) }],
        ]);
  ...
  return (
    <>
      ...
      <button onClick={controls.pause}>Pause</button> */}
        ...
        <ul id="boxs"  style={{ border: "10px solid #1c1ce9",  padding: 20, background: "green"}}>
